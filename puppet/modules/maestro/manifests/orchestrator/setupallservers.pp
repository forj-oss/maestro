...
)
{
  ...
  $metadata = "${parsed_extra_metadata}erosite=${::hostname}.${::maestro_id},erodomain=${instance_domain},eroip=${eroip},cdkdomain=${instance_domain},cdksite=<%= server_name %>,kitopsip=${::ipaddress}"
