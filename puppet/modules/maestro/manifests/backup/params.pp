...
class maestro::backup::params (
  ...
  $backup_status_hour          = hiera('maestro::backup::backup_status_hour', '03'),
  $backup_status_minute        = hiera('maestro::backup::backup_status_minute', '30'),
  $cdn_upload_hour             = hiera('maestro::backup::cdn_upload_hour', '04'),
  $cdn_upload_minute           = hiera('maestro::backup::cdn_upload_minute', '20'),
