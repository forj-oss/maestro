...
/**
 * Load ALL versions of the routes
 */

var setupAll = function(ver) {

  var setupMiddleware = function ( middlewareName ) {
    var routes = require( path.join(__dirname, 'middleware/'+ver, middlewareName) );
    console.log(routes);
...
/**
 * TODO: add your version here so that is loaded
 */
[
  'v1.0'
].forEach(setupAll);
